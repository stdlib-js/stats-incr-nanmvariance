...
<!-- <div class="equation" align="center" data-raw-text="s^2 = \frac{1}{W-1} \sum_{i=0}^{W-1} ( x_i - \bar{x} )^2" data-equation="eq:unbiased_sample_variance">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@b51ebff8a15e9d9cf8d9bb64d569d709f45fc994/lib/node_modules/@stdlib/stats/incr/nanmvariance/docs/img/equation_unbiased_sample_variance.svg" alt="Equation for the unbiased sample variance.">
    <br>
</div> -->
...
```javascript
import incrnanmvariance from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmvariance@esm/index.mjs';
```
